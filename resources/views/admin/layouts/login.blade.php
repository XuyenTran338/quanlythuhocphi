...
<style type="text/css">
    body{
        background-image: url('admin/public/assets/img/pattern/large_leather.png');
    }
</style>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3" style="margin-top: 100px">
            <div class="panel panel-primary">
                <div class="panel-heading" style="font-size: 20px"><i class="fas fa-sign-in-alt"></i> &nbsp;Login</div>
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ route('post_login') }}">
                        ...
                        <div class="form-group{{ $errors->has('txtPass') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="remember" {{ isset($email) ? 'checked' : '' }}> Remember Me
                                    </label>
                                </div>
                            </div>
                        </div>
