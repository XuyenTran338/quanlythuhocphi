...
<div class="row box" >
	<div class="col-sm-12" style="background-color: white; padding-top: 10px; border: 5px solid #4a7da3; border-radius: 10px">
		...
		<div class="col-sm-8">
			<form action="{{ route('post_pass',session()->get('users.ma_tai_khoan')) }}" method="post" onSubmit="return Pass()">
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				<div class="form-group">
					<label for="txtUser">Tên tài khoản*</label>
					<input type="text" value="{{ session()->get('users.ten_tai_khoan') }}" disabled class="form-control" name="txtUser">
				</div>
				<div class="form-group">
